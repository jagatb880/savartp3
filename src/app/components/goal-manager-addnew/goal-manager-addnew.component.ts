...
@Component({
  selector: 'app-goal-manager-addnew',
  templateUrl: './goal-manager-addnew.component.html',
  styleUrls: ['./goal-manager-addnew.component.scss'],
})
export class GoalManagerAddnewComponent implements OnInit {
  p_bar_value: number;
  r_bar_value:number;
  k_bar_value:number;
  planreached : boolean;
